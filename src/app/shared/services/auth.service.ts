...
export class AuthService {
  ...
  change_col_market(Data) {
    let URL = `${SharedClass.BASE_URL}/market/change_col`;
    return this.http.post(URL, Data);
  }
  get_customers(Data) {
    let URL = `${SharedClass.BASE_URL}/market/customer`;
    return this.http.post(URL, Data);
  }
  create_new_customer(Data) {
    let URL = `${SharedClass.BASE_URL}/market/customer/create`;
    return this.http.post(URL, Data);
  }
  create_many_new_customer(Data) {
    let URL = `${SharedClass.BASE_URL}/market/customer/create_many`;
    return this.http.post(URL, Data);
  }
  sendPhoneCode(data) {
    console.log(data);
